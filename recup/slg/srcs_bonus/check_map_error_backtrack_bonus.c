...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   check_map_error_backtrack_bonus.c                  :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tduprez <tduprez@student.42lyon.fr>        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/14 13:07:53 by tduprez           #+#    #+#             */
/*   Updated: 2022/12/22 12:01:32 by tduprez          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "../lib_bonus/check_map_error_bonus.h"

// VERIFIER QUE LE M NE BLOQUE PAS LA RECUPERATION D'UN C OU DEPLACEMENT P OU E
