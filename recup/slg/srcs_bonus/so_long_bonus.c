...
/*   Updated: 2022/12/22 13:39:55 by tduprez          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	what_texture(char c, int x, int y, t_slg slg)
{
	...
	if (c == 'E' && slg.i != 0)
		...
		img = mlx_xpm_file_to_image(mlx, "xpm/kay_o.xpm", &img_w, &img_h);
	else if (c == 'P' && slg.i != 0)
...
int	ft_move(int keycode, t_slg *slg)
{
	...
	if (keycode == 53 || (slg->str[slg->x][slg->y] == 'E' && slg->i == 0) || (slg->str[slg->x][slg->y] == 'M' && slg->i != 0))
	{
