...
# Documentation so_long

## <u>Le main :</u>

## <u>La fonction so_long :</u>
...
### - Number_of_collectible :

Number of collectible va parser la map t_slg->str et compter le nombre de collectibles sur la map et donne la valeur a slg->i
