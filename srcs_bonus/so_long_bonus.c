...
/*   Updated: 2023/01/09 13:29:32 by tduprez          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	what_texture(char c, int x, int y, t_slg slg)
{
	...
	mlx_win = slg.mlx_win;
	if (c == '1')
		img = mlx_xpm_file_to_image(mlx, "xpm_b/wood.xpm", &img_w, &img_h);
	else
		img = mlx_xpm_file_to_image(mlx, "xpm_b/ground.xpm", &img_w, &img_h);
	mlx_put_image_to_window(mlx, mlx_win, img, x * 100, y * 100);
	if (c == 'E' && slg.nb_c != 0)
		img = mlx_xpm_file_to_image(mlx, "xpm_b/door_c.xpm", &img_w, &img_h);
	else if (c == 'E' && slg.nb_c == 0)
		img = mlx_xpm_file_to_image(mlx, "xpm_b/door_o.xpm", &img_w, &img_h);
	else if (c == 'C')
		img = mlx_xpm_file_to_image(mlx, "xpm_b/ult_orb.xpm", &img_w, &img_h);
	else if (c == 'M')
		img = mlx_xpm_file_to_image(mlx, "xpm_b/kay_o.xpm", &img_w, &img_h);
